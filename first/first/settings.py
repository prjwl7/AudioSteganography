...
SECRET_KEY = 'django-insecure-7v3y*s6@a==f3a$h1$0x90@6mp&%0k01sm5wo)+rnz2ng6$om6'
...
# Add the following lines to the end of the file to handle media files during development
